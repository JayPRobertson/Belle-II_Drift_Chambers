...
class EventAction : public G4UserEventAction{
  public:
    ...
    void SetEntryTime(const G4double time) { tEntry = time; }
    G4double GetEntryTime() { return tEntry; }
    
    void SetInitEnergy(const G4double energy) { fEnergy = energy; }
    G4double GetInitEnergy() { return fEnergy; }
